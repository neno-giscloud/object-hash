...
function arrayifyObject(obj) {
    ...
    for (i = 0; i < l; i++) {
        ...
        ii = 2 * i;
        arr[ii] = key;
        arr[ii + 1] = arrayifyObject(obj[key]);
    }

    return arr;
}

window.objectHash = function onbjectHash() {
    return md5(JSON.stringify(arrayifyObject(obj)));
}
